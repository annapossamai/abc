...
file = open("/root/Desktop/Anna/tempo.txt", "a")
while 1:
    if (cont==4):  # 12 is the number of steps required to reach a more than 360 degrees angle (at the setted (speed,seconds)=(20,0.5)). 
	...
	# Salvataggio del tempo di esecuzione in un file di testo
	
	file.write("OFFSET 1: "+ str(execution_time)+ "\n")
        exit()
